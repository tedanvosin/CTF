...
def inv_mix_single_column(a):
    ...
    b = [0] * 4
    b[0] = mul9[a[0]] ^ mulb[a[1]] ^ muld[a[2]] ^ mule[a[3]]
    b[1] = mule[a[0]] ^ mul9[a[1]] ^ mulb[a[2]] ^ muld[a[3]]
    b[2] = muld[a[0]] ^ mule[a[1]] ^ mul9[a[2]] ^ mulb[a[3]]
    b[3] = mulb[a[0]] ^ muld[a[1]] ^ mule[a[2]] ^ mul9[a[3]]
    return b
